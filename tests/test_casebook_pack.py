"""Regression checks for the beacon-ui-grid-kit casebook."""
...
from casebook.harness import assert_expected, beacon_ui_grid_kit_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(beacon_ui_grid_kit_summary(), assert_expected())
